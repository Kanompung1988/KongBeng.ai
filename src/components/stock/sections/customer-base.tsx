...
export function CustomerBaseSection({ raw }: Props) {
  ...
  return (
    <section id="customerBase" className="scroll-mt-24">
      <SectionHeader icon={<Users className="w-5 h-5 text-blue-400" />} title="ฐานลูกค้า / Customer Base" />
      <div className="glass-card p-6 space-y-6">
        ...
        {data.stickiness && data.stickiness.length > 0 && (
          <div className="pt-4 border-t border-border/50">
            <h3 className="text-sm font-semibold text-foreground mb-3">Stickiness Factors</h3>
